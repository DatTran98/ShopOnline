    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <section class="content-header">
                <h1>
                    <?php echo $this->lang->line("Order Limit Setting");?>

                </h1>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> <?php echo $this->lang->line("Admin");?></a></li>
                    <li><a href="#"> <?php echo $this->lang->line("Order Limit Setting");?></a></li>
                    ...
                    <div class="col-xs-6">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title"> <?php echo $this->lang->line("Order Limit Setting");?></h3>
                            </div><!-- /.box-header -->
                            <!-- form start -->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <div class="btn-group">
                                                    <?php echo anchor('admin/edit_settings/'.$set->id, '<i class="fa fa-edit"></i>', array("class"=>"btn btn-success")); ?>
