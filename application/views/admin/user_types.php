                ...
                <div class="row">
                    ...
                    ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo site_url("admin/user_access/".$user_type->user_type_id); ?>"
                                                    class="btn btn-default"><?php echo $this->lang->line('Set Access')?></a>
                                            </td>
                                            <td>
                                                <a href="<?php echo site_url("admin/user_type_edit/".$user_type->user_type_id); ?>"
