                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-pattern">
                        <div class="card-body">
                            ...
                            <h4 class="font-size-20 mt-0 pt-1"><?php if(isset($total_orders)){ echo $total_orders;} ?></h4>
                ...
                <div class="col-xl-3 col-md-6">
                    <div class="card bg-pattern">
                        <div class="card-body">
                            ...
                            <h4 class="font-size-20 mt-0 pt-1"><?php if(isset($delivery_orders)){ echo $delivery_orders;} ?></h4>
                ...
                <div class="col-xl-3 col-md-6 ">
                    <div class="card bg-pattern">
                        <div class="card-body">
                            ...
                            <h4 class="font-size-20 mt-0 pt-1"><?php if(isset($accept_orders)){ echo $accept_orders;} ?></h4>
                ...
                <div class="col-xl-3 col-md-6 ">
                    <div class="card bg-pattern">
                        <div class="card-body">
                            ...
                            <h4 class="font-size-20 mt-0 pt-1"><?php if(isset($cancel_orders)){ echo $cancel_orders;} ?></h4>
