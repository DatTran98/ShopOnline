...
<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet"
        href="<?php echo base_url($this->config->item("theme_admin")."/dist/css/AdminLTE.min.css"); ?>" />
    <!-- iCheck -->
    <link rel="stylesheet"
        href="<?php echo base_url($this->config->item("theme_admin")."/plugins/iCheck/square/blue.css"); ?>" />
...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-box-body">
            ...
            <form id="signupform" class="form-horizontal" enctype="multipart/form-data" action="" method="post"
                role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-8">
                        <input type="password" class="form-control" name="r_password" placeholder="Re Password"
                            required="">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-offset-3 col-md-9">
                        <input type="submit" name="register" value='Update Password' id="btn-signup" type="button"
                            class="btn btn-info" />
